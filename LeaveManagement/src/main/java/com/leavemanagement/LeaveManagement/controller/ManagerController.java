...
public class ManagerController {
	...
	//here id is leave id
	@PutMapping("/setstatus/{lid}/by/{mid}")
	public ResponseEntity<BackendResponse> approveLeave(@Valid @RequestBody StatusDto statusDto,@PathVariable(name="lid") Integer lid,@PathVariable(name="mid") Integer mid){
		...
		try {
			...
			LeaveDto leaveDto = this.leaveService.setStatus(statusDto,lid,mid);
			backendResponse.setMessage("Getting leaves of user");
			backendResponse.setStatus("pass");
			backendResponse.setData(leaveDto);
			return new ResponseEntity<>(backendResponse,HttpStatus.OK);
